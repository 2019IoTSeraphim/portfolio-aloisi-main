        ...
        <nav
          ...
          <div className="flex lg:flex-1">
            <a href="#hero" className="">
              <span className="font-semibold md:font-bold text-lg md:text-xl">aloisi...</span>
            </a>
          </div>
          <div className="hidden md:flex md:gap-x-16 items-center lg:mr-16">
            {navigation.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-sm font-semibold leading-6 text-gray-900 hover:text-green-400 dark:text-white dark:hover:text-green-400">
                {item.name}
              </a>
            ))}
          </div>
